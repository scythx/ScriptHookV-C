...
/* PLAYER */
extern "C" Ped PED_GET_PLAYER_PED(Player);
Ped PED_GET_PLAYER_PED(Player player)
{
	return invoke<Ped>(0x43A66C31C68491C0, player);
}
extern "C" Ped PLAYER_GET_PLAYER_PED(Player);
Ped PLAYER_GET_PLAYER_PED(Player player)
{
	return invoke<Ped>(0x43A66C31C68491C0, player);
}
extern "C" Ped PLAYER_GET_PLAYER_PED_SCRIPT_INDEX(Player);
Ped PLAYER_GET_PLAYER_PED_SCRIPT_INDEX(Player player)
{
	return invoke<Ped>(0x50FAC3A3E030A6E1, player);
}
extern "C" void PLAYER_SET_PLAYER_MODEL(Player, Hash);
void PLAYER_SET_PLAYER_MODEL(Player player, Hash model)
{
	invoke<Void>(0x00A1CADD00108836, player, model);
}
extern "C" void PLAYER_CHANGE_PLAYER_PED(Player player, Ped ped, BOOL b2, BOOL b3);
void PLAYER_CHANGE_PLAYER_PED(Player player, Ped ped, BOOL b2, BOOL b3)
{
	invoke<Void>(0x048189FAC643DEEE, player, ped, b2, b3);
}
extern "C" void PLAYER_GET_PLAYER_RGB_COLOUR(Player player, int* r, int* g, int* b);
void PLAYER_GET_PLAYER_RGB_COLOUR(Player player, int* r, int* g, int* b)
{
	invoke<Void>(0xE902EF951DCE178F, player, r, g, b);
}
extern "C" int PLAYER_GET_NUMBER_OF_PLAYERS();
int PLAYER_GET_NUMBER_OF_PLAYERS()
{
	return invoke<int>(0x407C7F91DDB46C16);
}
int PLAYER_GET_PLAYER_TEAM(Player player)
{
	return invoke<int>(0x37039302F4E0A008, player);
}
extern "C" void PLAYER_SET_PLAYER_TEAM(Player, int);
void PLAYER_SET_PLAYER_TEAM(Player player, int team)
{
	invoke<Void>(0x0299FA38396A4940, player, team);
}
extern "C" char* PLAYER_GET_PLAYER_NAME(Player);
char* PLAYER_GET_PLAYER_NAME(Player player)
{
	return invoke<char*>(0x6D0DE6A7B5DA71F8, player);
}
extern "C" float PLAYER_GET_WANTED_LEVEL_RADIUS(Player);
float PLAYER_GET_WANTED_LEVEL_RADIUS(Player player)
{
	return invoke<float>(0x085DEB493BE80812, player);
}
extern "C" Vector3 PLAYER_GET_PLAYER_WANTED_CENTRE_POSITION(Player);
Vector3 PLAYER_GET_PLAYER_WANTED_CENTRE_POSITION(Player player)
{
	return invoke<Vector3>(0x0C92BA89F1AF26F8, player);
}
extern "C" void PLAYER_SET_PLAYER_WANTED_CENTRE_POSITION(Player player, float x, float y, float z);
void PLAYER_SET_PLAYER_WANTED_CENTRE_POSITION(Player player, float x, float y, float z)
{
	invoke<Void>(0x520E541A97A13354, player, x, y, z);
}
extern "C" int PLAYER_GET_WANTED_LEVEL_THRESHOLD(int);
int PLAYER_GET_WANTED_LEVEL_THRESHOLD(int wantedLevel)
{
	return invoke<int>(0xFDD179EAF45B556C, wantedLevel);
}
extern "C" void PLAYER_SET_PLAYER_WANTED_LEVEL(Player player, int wantedLevel, BOOL disableNoMission);
void PLAYER_SET_PLAYER_WANTED_LEVEL(Player player, int wantedLevel, BOOL disableNoMission)
{
	invoke<Void>(0x39FF19C64EF7DA5B, player, wantedLevel, disableNoMission);
}
extern "C" void PLAYER_SET_PLAYER_WANTED_LEVEL_NO_DROP(Player player, int wantedLevel, BOOL p2);
void PLAYER_SET_PLAYER_WANTED_LEVEL_NO_DROP(Player player, int wantedLevel, BOOL p2)
{
	invoke<Void>(0x340E61DE7F471565, player, wantedLevel, p2);
}
extern "C" void PLAYER_SET_PLAYER_WANTED_LEVEL_NOW(Player, BOOL);
void PLAYER_SET_PLAYER_WANTED_LEVEL_NOW(Player player, BOOL p1)
{
	invoke<Void>(0xE0A7D1E497FFCD6F, player, p1);
}
extern "C" BOOL PLAYER_ARE_PLAYER_FLASHING_STARS_ABOUT_TO_DROP(Player);
BOOL PLAYER_ARE_PLAYER_FLASHING_STARS_ABOUT_TO_DROP(Player player)
{
	return invoke<BOOL>(0xAFAF86043E5874E9, player);
}
extern "C" BOOL PLAYER_ARE_PLAYER_STARS_GREYED_OUT(Player);
BOOL PLAYER_ARE_PLAYER_STARS_GREYED_OUT(Player player)
{
	return invoke<BOOL>(0x0A6EB355EE14A2DB, player);
}
extern "C" void PLAYER_SET_DISPATCH_COPS_FOR_PLAYER(Player, BOOL);
void PLAYER_SET_DISPATCH_COPS_FOR_PLAYER(Player player, BOOL toggle)
{
	invoke<Void>(0xDB172424876553F4, player, toggle);
}
extern "C" BOOL PLAYER_IS_PLAYER_WANTED_LEVEL_GREATER(Player, int);
BOOL PLAYER_IS_PLAYER_WANTED_LEVEL_GREATER(Player player, int wantedLevel)
{
	return invoke<BOOL>(0x238DB2A2C23EE9EF, player, wantedLevel);
}
extern "C" void PLAYER_CLEAR_PLAYER_WANTED_LEVEL(Player);
void PLAYER_CLEAR_PLAYER_WANTED_LEVEL(Player player)
{
	invoke<Void>(0xB302540597885499, player);
}
extern "C" BOOL PLAYER_IS_PLAYER_DEAD(Player);
BOOL PLAYER_IS_PLAYER_DEAD(Player player)
{
	return invoke<BOOL>(0x424D4687FA1E5652, player);
}
extern "C" BOOL PLAYER_IS_PLAYER_PRESSING_HORN(Player);
BOOL PLAYER_IS_PLAYER_PRESSING_HORN(Player player)
{
	return invoke<BOOL>(0xFA1E2BF8B10598F9, player);
}
extern "C" void PLAYER_SET_PLAYER_CONTROL(Player player, BOOL toggle, int possiblyFlags);
void PLAYER_SET_PLAYER_CONTROL(Player player, BOOL toggle, int possiblyFlags)
{
	invoke<Void>(0x8D32347D6D4C40A2, player, toggle, possiblyFlags);
}
extern "C" int PLAYER_GET_PLAYER_WANTED_LEVEL(Player);
int PLAYER_GET_PLAYER_WANTED_LEVEL(Player player)
{
	return invoke<int>(0xE28E54788CE8F12D, player);
}
extern "C" void PLAYER_SET_MAX_WANTED_LEVEL(int);
void PLAYER_SET_MAX_WANTED_LEVEL(int maxWantedLevel)
{
	invoke<Void>(0xAA5F02DB48D704B9, maxWantedLevel);
}
extern "C" void PLAYER_SET_POLICE_RADAR_BLIPS(BOOL);
void PLAYER_SET_POLICE_RADAR_BLIPS(BOOL toggle)
{
	invoke<Void>(0x43286D561B72B8BF, toggle);
}
extern "C" void PLAYER_SET_POLICE_IGNORE_PLAYER(Player, BOOL);
void PLAYER_SET_POLICE_IGNORE_PLAYER(Player player, BOOL toggle)
{
	invoke<Void>(0x32C62AA929C2DA6A, player, toggle);
}
extern "C" BOOL PLAYER_IS_PLAYER_PLAYING(Player);
BOOL PLAYER_IS_PLAYER_PLAYING(Player player)
{
	return invoke<BOOL>(0x5E9564D8246B909A, player);
}
extern "C" void PLAYER_SET_EVERYONE_IGNORE_PLAYER(Player, BOOL);
void PLAYER_SET_EVERYONE_IGNORE_PLAYER(Player player, BOOL toggle)
{
	invoke<Void>(0x8EEDA153AD141BA4, player, toggle);
}
extern "C" void PLAYER_SET_ALL_RANDOM_PEDS_FLEE(Player, BOOL);
void PLAYER_SET_ALL_RANDOM_PEDS_FLEE(Player player, BOOL toggle)
{
	invoke<Void>(0x056E0FE8534C2949, player, toggle);
}
extern "C" void PLAYER_SET_ALL_RANDOM_PEDS_FLEE_THIS_FRAME(Player);
void PLAYER_SET_ALL_RANDOM_PEDS_FLEE_THIS_FRAME(Player player)
{
	invoke<Void>(0x471D2FF42A94B4F2, player);
}
extern "C" void PLAYER_SET_HUD_ANIM_STOP_LEVEL(Player, BOOL);
void PLAYER_SET_HUD_ANIM_STOP_LEVEL(Player player, BOOL toggle)
{
	invoke<Void>(0xDE45D1A1EF45EE61, player, toggle);
}
extern "C" void PLAYER_SET_AREAS_GENERATOR_ORIENTATION(Player);
void PLAYER_SET_AREAS_GENERATOR_ORIENTATION(Player player)
{
	invoke<Void>(0xC3376F42B1FACCC6, player);
}
extern "C" void PLAYER_SET_IGNORE_LOW_PRIORITY_SHOCKING_EVENTS(Player, BOOL);
void PLAYER_SET_IGNORE_LOW_PRIORITY_SHOCKING_EVENTS(Player player, BOOL toggle)
{
	invoke<Void>(0x596976B02B6B5700, player, toggle);
}
extern "C" void PLAYER_SET_WANTED_LEVEL_MULTIPLIER(float);
void PLAYER_SET_WANTED_LEVEL_MULTIPLIER(float multiplier)
{
	invoke<Void>(0x020E5F00CDA207BA, multiplier);
}
extern "C" void PLAYER_SET_WANTED_LEVEL_DIFFICULTY(Player, float);
void PLAYER_SET_WANTED_LEVEL_DIFFICULTY(Player player, float difficulty)
{
	invoke<Void>(0x9B0BB33B04405E7A, player, difficulty);
}
extern "C" void PLAYER_RESET_WANTED_LEVEL_DIFFICULTY(Player);
void PLAYER_RESET_WANTED_LEVEL_DIFFICULTY(Player player)
{
	invoke<Void>(0xB9D0DD990DC141DD, player);
}
extern "C" void PLAYER_START_FIRING_AMNESTY(int);
void PLAYER_START_FIRING_AMNESTY(int duration)
{
	invoke<Void>(0xBF9BD71691857E48, duration);
}
extern "C" void PLAYER_REPORT_CRIME(Player player, int crimeType, int wantedLvlThresh);
void PLAYER_REPORT_CRIME(Player player, int crimeType, int wantedLvlThresh)
{
	invoke<Void>(0xE9B09589827545E7, player, crimeType, wantedLvlThresh);
}
extern "C" void PLAYER_RESERVE_ENTITY_EXPLODES_ON_HIGH_EXPLOSION_COMBO(Player, int);
void PLAYER_RESERVE_ENTITY_EXPLODES_ON_HIGH_EXPLOSION_COMBO(Player player, int p1)
{
	invoke<Void>(0x9A987297ED8BD838, player, p1);
}
extern "C" void PLAYER__0xBC9490CA15AEA8FB(Player);
void PLAYER__0xBC9490CA15AEA8FB(Player player)
{
	invoke<Void>(0xBC9490CA15AEA8FB, player);
}
extern "C" void PLAYER__0x4669B3ED80F24B4E(Player);
void PLAYER__0x4669B3ED80F24B4E(Player player)
{
	invoke<Void>(0x4669B3ED80F24B4E, player);
}
extern "C" void PLAYER__0xAD73CE5A09E42D12(Player);
void PLAYER__0xAD73CE5A09E42D12(Player player)
{
	invoke<Void>(0xAD73CE5A09E42D12, player);
}
extern "C" void PLAYER__0x36F1B38855F2A8DF(Player);
void PLAYER__0x36F1B38855F2A8DF(Player player)
{
	invoke<Void>(0x36F1B38855F2A8DF, player);
}
extern "C" void PLAYER__0xDC64D2C53493ED12(Player);
void PLAYER__0xDC64D2C53493ED12(Player player)
{
	invoke<Void>(0xDC64D2C53493ED12, player);
}
extern "C" void PLAYER__0xB45EFF719D8427A6(float);
void PLAYER__0xB45EFF719D8427A6(float p0)
{
	invoke<Void>(0xB45EFF719D8427A6, p0);
}
extern "C" void PLAYER__0x0032A6DBA562C518();
void PLAYER__0x0032A6DBA562C518()
{
	invoke<Void>(0x0032A6DBA562C518);
}
BOOL PLAYER_CAN_PLAYER_START_MISSION(Player player)
{
	return invoke<BOOL>(0xDE7465A27D403C06, player);
}
extern "C" BOOL PLAYER_IS_PLAYER_READY_FOR_CUTSCENE(Player);
BOOL PLAYER_IS_PLAYER_READY_FOR_CUTSCENE(Player player)
{
	return invoke<BOOL>(0x908CBECC2CAA3690, player);
}
extern "C" BOOL PLAYER_IS_PLAYER_TARGETTING_ENTITY(Player, Entity);
BOOL PLAYER_IS_PLAYER_TARGETTING_ENTITY(Player player, Entity entity)
{
	return invoke<BOOL>(0x7912F7FC4F6264B6, player, entity);
}
extern "C" BOOL PLAYER_GET_PLAYER_TARGET_ENTITY(Player, Entity*);
BOOL PLAYER_GET_PLAYER_TARGET_ENTITY(Player player, Entity* entity)
{
	return invoke<BOOL>(0x13EDE1A5DBF797C9, player, entity);
}
extern "C" BOOL PLAYER_IS_PLAYER_FREE_AIMING(Player);
BOOL PLAYER_IS_PLAYER_FREE_AIMING(Player player)
{
	return invoke<BOOL>(0x2E397FD2ECD37C87, player);
}
extern "C" BOOL PLAYER_IS_PLAYER_FREE_AIMING_AT_ENTITY(Player, Entity);
BOOL PLAYER_IS_PLAYER_FREE_AIMING_AT_ENTITY(Player player, Entity entity)
{
	return invoke<BOOL>(0x3C06B5C839B38F7B, player, entity);
}
extern "C" Player PLAYER_GET_ENTITY_PLAYER_IS_FREE_AIMING_AT(Player, Entity*);
Player PLAYER_GET_ENTITY_PLAYER_IS_FREE_AIMING_AT(Player player, Entity* entity)
{
	return invoke<Player>(0x2975C866E6713290, player, entity);
}
extern "C" void PLAYER_SET_PLAYER_LOCKON_RANGE_OVERRIDE(Player, float);
void PLAYER_SET_PLAYER_LOCKON_RANGE_OVERRIDE(Player player, float range)
{
	invoke<Void>(0x29961D490E5814FD, player, range);
}
extern "C" void PLAYER_SET_PLAYER_CAN_DO_DRIVE_BY(Player, BOOL);
void PLAYER_SET_PLAYER_CAN_DO_DRIVE_BY(Player player, BOOL toggle)
{
	invoke<Void>(0x6E8834B52EC20C77, player, toggle);
}
extern "C" void PLAYER_SET_PLAYER_CAN_BE_HASSLED_BY_GANGS(Player, BOOL);
void PLAYER_SET_PLAYER_CAN_BE_HASSLED_BY_GANGS(Player player, BOOL toggle)
{
	invoke<Void>(0xD5E460AD7020A246, player, toggle);
}
extern "C" void PLAYER_SET_PLAYER_CAN_USE_COVER(Player, BOOL);
void PLAYER_SET_PLAYER_CAN_USE_COVER(Player player, BOOL toggle)
{
	invoke<Void>(0xD465A8599DFF6814, player, toggle);
}
extern "C" int PLAYER_GET_MAX_WANTED_LEVEL();
int PLAYER_GET_MAX_WANTED_LEVEL()
{
	return invoke<int>(0x462E0DB9B137DC5F);
}
BOOL PLAYER_IS_PLAYER_TARGETTING_ANYTHING(Player player)
{
	return invoke<BOOL>(0x78CFE51896B6B8A4, player);
}
extern "C" void PLAYER_SET_PLAYER_SPRINT(Player, BOOL);
void PLAYER_SET_PLAYER_SPRINT(Player player, BOOL toggle)
{
	invoke<Void>(0xA01B8075D8B92DF4, player, toggle);
}
extern "C" void PLAYER_RESET_PLAYER_STAMINA(Player);
void PLAYER_RESET_PLAYER_STAMINA(Player player)
{
	invoke<Void>(0xA6F312FCCE9C1DFE, player);
}
extern "C" void PLAYER_RESTORE_PLAYER_STAMINA(Player, float);
void PLAYER_RESTORE_PLAYER_STAMINA(Player player, float p1)
{
	invoke<Void>(0xA352C1B864CAFD33, player, p1);
}
extern "C" float PLAYER_GET_PLAYER_SPRINT_STAMINA_REMAINING(Player);
float PLAYER_GET_PLAYER_SPRINT_STAMINA_REMAINING(Player player)
{
	return invoke<float>(0x3F9F16F8E65A7ED7, player);
}
extern "C" float PLAYER_GET_PLAYER_SPRINT_TIME_REMAINING(Player);
float PLAYER_GET_PLAYER_SPRINT_TIME_REMAINING(Player player)
{
	return invoke<float>(0x1885BC9B108B4C99, player);
}
extern "C" float PLAYER_GET_PLAYER_UNDERWATER_TIME_REMAINING(Player);
float PLAYER_GET_PLAYER_UNDERWATER_TIME_REMAINING(Player player)
{
	return invoke<float>(0xA1FCF8E6AF40B731, player);
}
extern "C" int PLAYER_GET_PLAYER_GROUP(Player);
int PLAYER_GET_PLAYER_GROUP(Player player)
{
	return invoke<int>(0x0D127585F77030AF, player);
}
extern "C" int PLAYER_GET_PLAYER_MAX_ARMOUR(Player);
int PLAYER_GET_PLAYER_MAX_ARMOUR(Player player)
{
	return invoke<int>(0x92659B4CE1863CB3, player);
}
extern "C" BOOL PLAYER_IS_PLAYER_CONTROL_ON(Player);
BOOL PLAYER_IS_PLAYER_CONTROL_ON(Player player)
{
	return invoke<BOOL>(0x49C32D60007AFA47, player);
}
extern "C" BOOL PLAYER__IS_PLAYER_CAM_CONTROL_DISABLED();
BOOL PLAYER__IS_PLAYER_CAM_CONTROL_DISABLED()
{
	return invoke<BOOL>(0x7C814D2FB49F40C0);
}
BOOL PLAYER_IS_PLAYER_SCRIPT_CONTROL_ON(Player player)
{
	return invoke<BOOL>(0x8A876A65283DD7D7, player);
}
extern "C" BOOL PLAYER_IS_PLAYER_CLIMBING(Player);
BOOL PLAYER_IS_PLAYER_CLIMBING(Player player)
{
	return invoke<BOOL>(0x95E8F73DC65EFB9C, player);
}
extern "C" BOOL PLAYER_IS_PLAYER_BEING_ARRESTED(Player, BOOL);
BOOL PLAYER_IS_PLAYER_BEING_ARRESTED(Player player, BOOL atArresting)
{
	return invoke<BOOL>(0x388A47C51ABDAC8E, player, atArresting);
}
extern "C" void PLAYER_RESET_PLAYER_ARREST_STATE(Player);
void PLAYER_RESET_PLAYER_ARREST_STATE(Player player)
{
	invoke<Void>(0x2D03E13C460760D6, player);
}
extern "C" Vehicle PLAYER_GET_PLAYERS_LAST_VEHICLE();
Vehicle PLAYER_GET_PLAYERS_LAST_VEHICLE()
{
	return invoke<Vehicle>(0xB6997A7EB3F5C8C0);
}
Player PLAYER_INT_TO_PLAYERINDEX(int value)
{
	return invoke<Player>(0x41BD2A6B006AF756, value);
}
extern "C" int PLAYER_INT_TO_PARTICIPANTINDEX(int);
int PLAYER_INT_TO_PARTICIPANTINDEX(int value)
{
	return invoke<int>(0x9EC6603812C24710, value);
}
extern "C" int PLAYER_GET_TIME_SINCE_PLAYER_HIT_VEHICLE(Player);
int PLAYER_GET_TIME_SINCE_PLAYER_HIT_VEHICLE(Player player)
{
	return invoke<int>(0x5D35ECF3A81A0EE0, player);
}
extern "C" int PLAYER_GET_TIME_SINCE_PLAYER_HIT_PED(Player);
int PLAYER_GET_TIME_SINCE_PLAYER_HIT_PED(Player player)
{
	return invoke<int>(0xE36A25322DC35F42, player);
}
extern "C" int PLAYER_GET_TIME_SINCE_PLAYER_DROVE_ON_PAVEMENT(Player);
int PLAYER_GET_TIME_SINCE_PLAYER_DROVE_ON_PAVEMENT(Player player)
{
	return invoke<int>(0xD559D2BE9E37853B, player);
}
extern "C" int PLAYER_GET_TIME_SINCE_PLAYER_DROVE_AGAINST_TRAFFIC(Player);
int PLAYER_GET_TIME_SINCE_PLAYER_DROVE_AGAINST_TRAFFIC(Player player)
{
	return invoke<int>(0xDB89591E290D9182, player);
}
extern "C" BOOL PLAYER_IS_PLAYER_FREE_FOR_AMBIENT_TASK(Player);
BOOL PLAYER_IS_PLAYER_FREE_FOR_AMBIENT_TASK(Player player)
{
	return invoke<BOOL>(0xDCCFD3F106C36AB4, player);
}
extern "C" Player PLAYER_PLAYER_ID();
Player PLAYER_PLAYER_ID()
{
	return invoke<Player>(0x4F8644AF03D0E0D6); 
}
BOOL PLAYER_HAS_FORCE_CLEANUP_OCCURRED(int cleanupFlags)
{
	return invoke<BOOL>(0xC968670BFACE42D9, cleanupFlags);
}
extern "C" void PLAYER_FORCE_CLEANUP(int);
void PLAYER_FORCE_CLEANUP(int cleanupFlags)
{
	invoke<Void>(0xBC8983F38F78ED51, cleanupFlags);
}
extern "C" void PLAYER_FORCE_CLEANUP_FOR_ALL_THREADS_WITH_THIS_NAME(char*, int);
void PLAYER_FORCE_CLEANUP_FOR_ALL_THREADS_WITH_THIS_NAME(char* name, int cleanupFlags)
{
	invoke<Void>(0x4C68DDDDF0097317, name, cleanupFlags);
}
extern "C" void PLAYER_FORCE_CLEANUP_FOR_THREAD_WITH_THIS_ID(int, int);
void PLAYER_FORCE_CLEANUP_FOR_THREAD_WITH_THIS_ID(int id, int cleanupFlags)
{
	invoke<Void>(0xF745B37630DF176B, id, cleanupFlags);
}
extern "C" int PLAYER_GET_CAUSE_OF_MOST_RECENT_FORCE_CLEANUP();
int PLAYER_GET_CAUSE_OF_MOST_RECENT_FORCE_CLEANUP()
{
	return invoke<int>(0x9A41CF4674A12272);
}
extern "C" void PLAYER_SET_PLAYER_MAY_ONLY_ENTER_THIS_VEHICLE(Player, Vehicle);
void PLAYER_SET_PLAYER_MAY_ONLY_ENTER_THIS_VEHICLE(Player player, Vehicle vehicle)
{
	invoke<Void>(0x8026FF78F208978A, player, vehicle);
}
extern "C" void PLAYER_SET_PLAYER_MAY_NOT_ENTER_ANY_VEHICLE(Player);
void PLAYER_SET_PLAYER_MAY_NOT_ENTER_ANY_VEHICLE(Player player)
{
	invoke<Void>(0x1DE37BBF9E9CC14A, player);
}
extern "C" BOOL PLAYER_GIVE_ACHIEVEMENT_TO_PLAYER(int);
BOOL PLAYER_GIVE_ACHIEVEMENT_TO_PLAYER(int achievement)
{
	return invoke<BOOL>(0xBEC7076D64130195, achievement);
}
extern "C" BOOL PLAYER__0xC2AFFFDABBDC2C5C(Any, Any);
BOOL PLAYER__0xC2AFFFDABBDC2C5C(Any p0, Any p1)
{
	return invoke<BOOL>(0xC2AFFFDABBDC2C5C, p0, p1);
}
extern "C" Cam PLAYER__0x1C186837D0619335(Any);
Cam PLAYER__0x1C186837D0619335(Any p0)
{
	return invoke<Cam>(0x1C186837D0619335, p0);
}
extern "C" BOOL PLAYER_HAS_ACHIEVEMENT_BEEN_PASSED(int);
BOOL PLAYER_HAS_ACHIEVEMENT_BEEN_PASSED(int achievement)
{
	return invoke<BOOL>(0x867365E111A3B6EB, achievement);
}
extern "C" BOOL PLAYER_IS_PLAYER_ONLINE();
BOOL PLAYER_IS_PLAYER_ONLINE()
{
	return invoke<BOOL>(0xF25D331DC2627BBC);
}
void PLAYER_DISPLAY_SYSTEM_SIGNIN_UI(BOOL unk)
{
	invoke<Void>(0x94DD7888C10A979E, unk);
}
extern "C" BOOL PLAYER_IS_SYSTEM_UI_BEING_DISPLAYED();
BOOL PLAYER_IS_SYSTEM_UI_BEING_DISPLAYED()
{
	return invoke<BOOL>(0x5D511E3867C87139);
}
extern "C" void PLAYER_SET_PLAYER_INVINCIBLE(Player, BOOL);
void PLAYER_SET_PLAYER_INVINCIBLE(Player player, BOOL toggle)
{
	invoke<Void>(0x239528EACDC3E7DE, player, toggle);
}
extern "C" BOOL PLAYER_GET_PLAYER_INVINCIBLE(Player);
BOOL PLAYER_GET_PLAYER_INVINCIBLE(Player player)
{
	return invoke<BOOL>(0xB721981B2B939E07, player);
}
extern "C" void PLAYER__0xCAC57395B151135F(Player, BOOL);
void PLAYER__0xCAC57395B151135F(Player player, BOOL p1)
{
	invoke<Void>(0xCAC57395B151135F, player, p1);
}
extern "C" void PLAYER_REMOVE_PLAYER_HELMET(Player, BOOL);
void PLAYER_REMOVE_PLAYER_HELMET(Player player, BOOL p2)
{
	invoke<Void>(0xF3AC26D3CC576528, player, p2);
}
extern "C" void PLAYER_GIVE_PLAYER_RAGDOLL_CONTROL(Player, BOOL);
void PLAYER_GIVE_PLAYER_RAGDOLL_CONTROL(Player player, BOOL toggle)
{
	invoke<Void>(0x3C49C870E66F0A28, player, toggle);
}
extern "C" void PLAYER_SET_PLAYER_LOCKON(Player, BOOL);
void PLAYER_SET_PLAYER_LOCKON(Player player, BOOL toggle)
{
	invoke<Void>(0x5C8B2F450EE4328E, player, toggle);
}
extern "C" void PLAYER_SET_PLAYER_TARGETING_MODE(int);
void PLAYER_SET_PLAYER_TARGETING_MODE(int targetMode)
{
	invoke<Void>(0xB1906895227793F3, targetMode);
}
extern "C" void PLAYER__0x5702B917B99DB1CD(Any);
void PLAYER__0x5702B917B99DB1CD(Any p0)
{
	invoke<Void>(0x5702B917B99DB1CD, p0);
}
extern "C" Any PLAYER__0xB9CF1F793A9F1BF1();
Any PLAYER__0xB9CF1F793A9F1BF1()
{
	return invoke<Any>(0xB9CF1F793A9F1BF1);
}
void PLAYER_CLEAR_PLAYER_HAS_DAMAGED_AT_LEAST_ONE_PED(Player player)
{
	invoke<Void>(0xF0B67A4DE6AB5F98, player);
}
extern "C" BOOL PLAYER_HAS_PLAYER_DAMAGED_AT_LEAST_ONE_PED(Player);
BOOL PLAYER_HAS_PLAYER_DAMAGED_AT_LEAST_ONE_PED(Player player)
{
	return invoke<BOOL>(0x20CE80B0C2BF4ACC, player);
}
extern "C" void PLAYER_CLEAR_PLAYER_HAS_DAMAGED_AT_LEAST_ONE_NON_ANIMAL_PED(Player);
void PLAYER_CLEAR_PLAYER_HAS_DAMAGED_AT_LEAST_ONE_NON_ANIMAL_PED(Player player)
{
	invoke<Void>(0x4AACB96203D11A31, player);
}
extern "C" BOOL PLAYER_HAS_PLAYER_DAMAGED_AT_LEAST_ONE_NON_ANIMAL_PED(Player);
BOOL PLAYER_HAS_PLAYER_DAMAGED_AT_LEAST_ONE_NON_ANIMAL_PED(Player player)
{
	return invoke<BOOL>(0xE4B90F367BD81752, player);
}
extern "C" void PLAYER_SET_AIR_DRAG_MULTIPLIER_FOR_PLAYERS_VEHICLE(Player, float);
void PLAYER_SET_AIR_DRAG_MULTIPLIER_FOR_PLAYERS_VEHICLE(Player player, float multiplier)
{
	invoke<Void>(0xCA7DC8329F0A1E9E, player, multiplier);
}
extern "C" void PLAYER_SET_SWIM_MULTIPLIER_FOR_PLAYER(Player, float);
void PLAYER_SET_SWIM_MULTIPLIER_FOR_PLAYER(Player player, float multiplier)
{
	invoke<Void>(0xA91C6F0FF7D16A13, player, multiplier);
}
extern "C" void PLAYER_SET_RUN_SPRINT_MULTIPLIER_FOR_PLAYER(Player, float);
void PLAYER_SET_RUN_SPRINT_MULTIPLIER_FOR_PLAYER(Player player, float multiplier)
{
	invoke<Void>(0x6DB47AA77FD94E09, player, multiplier);
}
extern "C" int PLAYER_GET_TIME_SINCE_LAST_ARREST();
int PLAYER_GET_TIME_SINCE_LAST_ARREST()
{
	return invoke<int>(0x5063F92F07C2A316);
}
extern "C" void PLAYER_SET_PLAYER_FORCED_AIM(Player, BOOL);
void PLAYER_SET_PLAYER_FORCED_AIM(Player player, BOOL toggle)
{
	invoke<Void>(0x0FEE4F80AC44A726, player, toggle);
}
extern "C" void PLAYER_SET_PLAYER_FORCED_ZOOM(Player, BOOL);
void PLAYER_SET_PLAYER_FORCED_ZOOM(Player player, BOOL toggle)
{
	invoke<Void>(0x75E7D505F2B15902, player, toggle);
}
extern "C" void PLAYER_SET_PLAYER_FORCE_SKIP_AIM_INTRO(Player, BOOL);
void PLAYER_SET_PLAYER_FORCE_SKIP_AIM_INTRO(Player player, BOOL toggle)
{
	invoke<Void>(0x7651BC64AE59E128, player, toggle);
}
extern "C" void PLAYER_DISABLE_PLAYER_FIRING(Player, BOOL);
void PLAYER_DISABLE_PLAYER_FIRING(Player player, BOOL toggle)
{
	invoke<Void>(0x5E6CC07646BBEAB8, player, toggle);
}
extern "C" void PLAYER__0xB885852C39CC265D();
void PLAYER__0xB885852C39CC265D()
{
	invoke<Void>(0xB885852C39CC265D);
}
extern "C" void PLAYER_SET_DISABLE_AMBIENT_MELEE_MOVE(Player, BOOL);
void PLAYER_SET_DISABLE_AMBIENT_MELEE_MOVE(Player player, BOOL toggle)
{
	invoke<Void>(0x2E8AABFA40A84F8C, player, toggle);
}
extern "C" void PLAYER_SET_PLAYER_MAX_ARMOUR(Player, int);
void PLAYER_SET_PLAYER_MAX_ARMOUR(Player player, int value)
{
	invoke<Void>(0x77DFCCF5948B8C71, player, value);
}
extern "C" void PLAYER_SPECIAL_ABILITY_DEACTIVATE(Player);
void PLAYER_SPECIAL_ABILITY_DEACTIVATE(Player player)
{
	invoke<Void>(0xD6A953C6D1492057, player);
}
extern "C" void PLAYER_SPECIAL_ABILITY_DEACTIVATE_FAST(Player);
void PLAYER_SPECIAL_ABILITY_DEACTIVATE_FAST(Player player)
{
	invoke<Void>(0x9CB5CE07A3968D5A, player);
}
extern "C" void PLAYER_SPECIAL_ABILITY_RESET(Player);
void PLAYER_SPECIAL_ABILITY_RESET(Player player)
{
	invoke<Void>(0x375F0E738F861A94, player);
}
extern "C" void PLAYER__0xC9A763D8FE87436A(Player);
void PLAYER__0xC9A763D8FE87436A(Player player)
{
	invoke<Void>(0xC9A763D8FE87436A, player);
}
extern "C" void PLAYER_SPECIAL_ABILITY_CHARGE_SMALL(Player player, BOOL p1, BOOL p2);
void PLAYER_SPECIAL_ABILITY_CHARGE_SMALL(Player player, BOOL p1, BOOL p2)
{
	invoke<Void>(0x2E7B9B683481687D, player, p1, p2);
}
extern "C" void PLAYER_SPECIAL_ABILITY_CHARGE_MEDIUM(Player player, BOOL p1, BOOL p2);
void PLAYER_SPECIAL_ABILITY_CHARGE_MEDIUM(Player player, BOOL p1, BOOL p2)
{
	invoke<Void>(0xF113E3AA9BC54613, player, p1, p2);
}
extern "C" void PLAYER_SPECIAL_ABILITY_CHARGE_LARGE(Player player, BOOL p1, BOOL p2);
void PLAYER_SPECIAL_ABILITY_CHARGE_LARGE(Player player, BOOL p1, BOOL p2)
{
	invoke<Void>(0xF733F45FA4497D93, player, p1, p2);
}
extern "C" void PLAYER_SPECIAL_ABILITY_CHARGE_CONTINUOUS(Player, BOOL);
void PLAYER_SPECIAL_ABILITY_CHARGE_CONTINUOUS(Player player, BOOL p1)
{
	invoke<Void>(0xED481732DFF7E997, player, p1);
}
extern "C" void PLAYER_SPECIAL_ABILITY_CHARGE_ABSOLUTE(Player player, int p1, BOOL p2);
void PLAYER_SPECIAL_ABILITY_CHARGE_ABSOLUTE(Player player, int p1, BOOL p2)
{
	invoke<Void>(0xB7B0870EB531D08D, player, p1, p2);
}
extern "C" void PLAYER_SPECIAL_ABILITY_CHARGE_NORMALIZED(Player player, float normalizedValue, BOOL p2);
void PLAYER_SPECIAL_ABILITY_CHARGE_NORMALIZED(Player player, float normalizedValue, BOOL p2)
{
	invoke<Void>(0xA0696A65F009EE18, player, normalizedValue, p2);
}
extern "C" void PLAYER_SPECIAL_ABILITY_FILL_METER(Player, BOOL);
void PLAYER_SPECIAL_ABILITY_FILL_METER(Player player, BOOL p1)
{
	invoke<Void>(0x3DACA8DDC6FD4980, player, p1);
}
extern "C" void PLAYER_SPECIAL_ABILITY_DEPLETE_METER(Player, BOOL);
void PLAYER_SPECIAL_ABILITY_DEPLETE_METER(Player player, BOOL p1)
{
	invoke<Void>(0x1D506DBBBC51E64B, player, p1);
}
extern "C" void PLAYER_SPECIAL_ABILITY_LOCK(Hash);
void PLAYER_SPECIAL_ABILITY_LOCK(Hash playerModel)
{
	invoke<Void>(0x6A09D0D590A47D13, playerModel);
}
extern "C" void PLAYER_SPECIAL_ABILITY_UNLOCK(Hash);
void PLAYER_SPECIAL_ABILITY_UNLOCK(Hash playerModel)
{
	invoke<Void>(0xF145F3BE2EFA9A3B, playerModel);
}
extern "C" BOOL PLAYER_IS_SPECIAL_ABILITY_UNLOCKED(Hash);
BOOL PLAYER_IS_SPECIAL_ABILITY_UNLOCKED(Hash playerModel)
{
	return invoke<BOOL>(0xC6017F6A6CDFA694, playerModel);
}
extern "C" BOOL PLAYER_IS_SPECIAL_ABILITY_ACTIVE(Player);
BOOL PLAYER_IS_SPECIAL_ABILITY_ACTIVE(Player player)
{
	return invoke<BOOL>(0x3E5F7FC85D854E15, player);
}
extern "C" BOOL PLAYER_IS_SPECIAL_ABILITY_METER_FULL(Player);
BOOL PLAYER_IS_SPECIAL_ABILITY_METER_FULL(Player player)
{
	return invoke<BOOL>(0x05A1FE504B7F2587, player);
}
extern "C" void PLAYER_ENABLE_SPECIAL_ABILITY(Player, BOOL);
void PLAYER_ENABLE_SPECIAL_ABILITY(Player player, BOOL toggle)
{
	invoke<Void>(0x181EC197DAEFE121, player, toggle);
}
extern "C" BOOL PLAYER_IS_SPECIAL_ABILITY_ENABLED(Player);
BOOL PLAYER_IS_SPECIAL_ABILITY_ENABLED(Player player)
{
	return invoke<BOOL>(0xB1D200FE26AEF3CB, player);
}
extern "C" void PLAYER_SET_SPECIAL_ABILITY_MULTIPLIER(float);
void PLAYER_SET_SPECIAL_ABILITY_MULTIPLIER(float multiplier)
{
	invoke<Void>(0xA49C426ED0CA4AB7, multiplier);
}
extern "C" void PLAYER__0xFFEE8FA29AB9A18E(Player);
void PLAYER__0xFFEE8FA29AB9A18E(Player player)
{
	invoke<Void>(0xFFEE8FA29AB9A18E, player);
}
extern "C" BOOL PLAYER__0x5FC472C501CCADB3(Player);
BOOL PLAYER__0x5FC472C501CCADB3(Player player)
{
	return invoke<BOOL>(0x5FC472C501CCADB3, player);
}
extern "C" BOOL PLAYER__0xF10B44FD479D69F3(Player, int);
BOOL PLAYER__0xF10B44FD479D69F3(Player player, int p1)
{
	return invoke<BOOL>(0xF10B44FD479D69F3, player, p1);
}
extern "C" BOOL PLAYER__0xDD2620B7B9D16FF1(Player, float);
BOOL PLAYER__0xDD2620B7B9D16FF1(Player player, float p1)
{
	return invoke<BOOL>(0xDD2620B7B9D16FF1, player, p1);
}
extern "C" void PLAYER_START_PLAYER_TELEPORT(Player player, float x, float y, float z, float heading, BOOL p5, BOOL p6, BOOL p7);
void PLAYER_START_PLAYER_TELEPORT(Player player, float x, float y, float z, float heading, BOOL p5, BOOL p6, BOOL p7)
{
	invoke<Void>(0xAD15F075A4DA0FDE, player, x, y, z, heading, p5, p6, p7);
}
extern "C" BOOL PLAYER__HAS_PLAYER_TELEPORT_FINISHED(Player);
BOOL PLAYER__HAS_PLAYER_TELEPORT_FINISHED(Player player)
{
	return invoke<BOOL>(0xE23D5873C2394C61, player);
}
extern "C" void PLAYER_STOP_PLAYER_TELEPORT();
void PLAYER_STOP_PLAYER_TELEPORT()
{
	invoke<Void>(0xC449EDED9D73009C);
}
float PLAYER_GET_PLAYER_CURRENT_STEALTH_NOISE(Player player)
{
	return invoke<float>(0x2F395D61F3A1F877, player);
}
extern "C" void PLAYER_SET_PLAYER_HEALTH_RECHARGE_MULTIPLIER(Player, float);
void PLAYER_SET_PLAYER_HEALTH_RECHARGE_MULTIPLIER(Player player, float regenRate)
{
	invoke<Void>(0x5DB660B38DD98A31, player, regenRate);
}
extern "C" void PLAYER_SET_PLAYER_WEAPON_DAMAGE_MODIFIER(Player, float);
void PLAYER_SET_PLAYER_WEAPON_DAMAGE_MODIFIER(Player player, float damageAmount)
{
	invoke<Void>(0xCE07B9F7817AADA3, player, damageAmount);
}
extern "C" void PLAYER_SET_PLAYER_WEAPON_DEFENSE_MODIFIER(Player, float);
void PLAYER_SET_PLAYER_WEAPON_DEFENSE_MODIFIER(Player player, float modifier)
{
	invoke<Void>(0x2D83BC011CA14A3C, player, modifier);
}
extern "C" void PLAYER_SET_PLAYER_MELEE_WEAPON_DAMAGE_MODIFIER(Player, float);
void PLAYER_SET_PLAYER_MELEE_WEAPON_DAMAGE_MODIFIER(Player player, float modifier)
{
	invoke<Void>(0x4A3DC7ECCC321032, player, modifier);
}
extern "C" void PLAYER_SET_PLAYER_MELEE_WEAPON_DEFENSE_MODIFIER(Player, float);
void PLAYER_SET_PLAYER_MELEE_WEAPON_DEFENSE_MODIFIER(Player player, float modifier)
{
	invoke<Void>(0xAE540335B4ABC4E2, player, modifier);
}
extern "C" void PLAYER_SET_PLAYER_VEHICLE_DAMAGE_MODIFIER(Player, float);
void PLAYER_SET_PLAYER_VEHICLE_DAMAGE_MODIFIER(Player player, float damageAmount)
{
	invoke<Void>(0xA50E117CDDF82F0C, player, damageAmount);
}
extern "C" void PLAYER_SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(Player, float);
void PLAYER_SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(Player player, float modifier)
{
	invoke<Void>(0x4C60E6EFDAFF2462, player, modifier);
}
extern "C" void PLAYER_SET_PLAYER_PARACHUTE_TINT_INDEX(Player, int);
void PLAYER_SET_PLAYER_PARACHUTE_TINT_INDEX(Player player, int tintIndex)
{
	invoke<Void>(0xA3D0E54541D9A5E5, player, tintIndex);
}
extern "C" void PLAYER_GET_PLAYER_PARACHUTE_TINT_INDEX(Player, int*);
void PLAYER_GET_PLAYER_PARACHUTE_TINT_INDEX(Player player, int* tintIndex)
{
	invoke<Void>(0x75D3F7A1B0D9B145, player, tintIndex);
}
extern "C" void PLAYER_SET_PLAYER_RESERVE_PARACHUTE_TINT_INDEX(Player, int);
void PLAYER_SET_PLAYER_RESERVE_PARACHUTE_TINT_INDEX(Player player, int index)
{
	invoke<Void>(0xAF04C87F5DC1DF38, player, index);
}
extern "C" void PLAYER_GET_PLAYER_RESERVE_PARACHUTE_TINT_INDEX(Player, int*);
void PLAYER_GET_PLAYER_RESERVE_PARACHUTE_TINT_INDEX(Player player, int* index)
{
	invoke<Void>(0xD5A016BC3C09CF40, player, index);
}
extern "C" void PLAYER_SET_PLAYER_PARACHUTE_PACK_TINT_INDEX(Player, int);
void PLAYER_SET_PLAYER_PARACHUTE_PACK_TINT_INDEX(Player player, int tintIndex)
{
	invoke<Void>(0x93B0FB27C9A04060, player, tintIndex);
}
extern "C" void PLAYER_GET_PLAYER_PARACHUTE_PACK_TINT_INDEX(Player player, int* tintIndex);
void PLAYER_GET_PLAYER_PARACHUTE_PACK_TINT_INDEX(Player player, int* tintIndex)
{
	invoke<Void>(0x6E9C742F340CE5A2, player, tintIndex);
}
extern "C" void PLAYER_SET_PLAYER_HAS_RESERVE_PARACHUTE(Player);
void PLAYER_SET_PLAYER_HAS_RESERVE_PARACHUTE(Player player)
{
	invoke<Void>(0x7DDAB28D31FAC363, player);
}
extern "C" BOOL PLAYER_GET_PLAYER_HAS_RESERVE_PARACHUTE(Player);
BOOL PLAYER_GET_PLAYER_HAS_RESERVE_PARACHUTE(Player player)
{
	return invoke<BOOL>(0x5DDFE2FF727F3CA3, player);
}
extern "C" void PLAYER_SET_PLAYER_CAN_LEAVE_PARACHUTE_SMOKE_TRAIL(Player player, BOOL enabled);
void PLAYER_SET_PLAYER_CAN_LEAVE_PARACHUTE_SMOKE_TRAIL(Player player, BOOL enabled)
{
	invoke<Void>(0xF401B182DBA8AF53, player, enabled);
}
extern "C" void PLAYER_SET_PLAYER_PARACHUTE_SMOKE_TRAIL_COLOR(Player player, int r, int g, int b);
void PLAYER_SET_PLAYER_PARACHUTE_SMOKE_TRAIL_COLOR(Player player, int r, int g, int b)
{
	invoke<Void>(0x8217FD371A4625CF, player, r, g, b);
}
extern "C" void PLAYER_GET_PLAYER_PARACHUTE_SMOKE_TRAIL_COLOR(Player player, int* r, int* g, int* b);
void PLAYER_GET_PLAYER_PARACHUTE_SMOKE_TRAIL_COLOR(Player player, int* r, int* g, int* b)
{
	invoke<Void>(0xEF56DBABD3CD4887, player, r, g, b);
}
extern "C" void PLAYER_SET_PLAYER_RESET_FLAG_PREFER_REAR_SEATS(Player player, int flags);
void PLAYER_SET_PLAYER_RESET_FLAG_PREFER_REAR_SEATS(Player player, int flags)
{
	invoke<Void>(0x11D5F725F0E780E0, player, flags);
}
extern "C" void PLAYER_SET_PLAYER_NOISE_MULTIPLIER(Player player, float multiplier);
void PLAYER_SET_PLAYER_NOISE_MULTIPLIER(Player player, float multiplier)
{
	invoke<Void>(0xDB89EF50FF25FCE9, player, multiplier);
}
extern "C" void PLAYER_SET_PLAYER_SNEAKING_NOISE_MULTIPLIER(Player player, float multiplier);
void PLAYER_SET_PLAYER_SNEAKING_NOISE_MULTIPLIER(Player player, float multiplier)
{
	invoke<Void>(0xB2C1A29588A9F47C, player, multiplier);
}
extern "C" BOOL PLAYER_CAN_PED_HEAR_PLAYER(Player player, Ped ped);
BOOL PLAYER_CAN_PED_HEAR_PLAYER(Player player, Ped ped)
{
	return invoke<BOOL>(0xF297383AA91DCA29, player, ped);
}
extern "C" void PLAYER_SIMULATE_PLAYER_INPUT_GAIT(Player player, float amount, int gaitType, float speed, BOOL p4, BOOL p5);
void PLAYER_SIMULATE_PLAYER_INPUT_GAIT(Player player, float amount, int gaitType, float speed, BOOL p4, BOOL p5)
{
	invoke<Void>(0x477D5D63E63ECA5D, player, amount, gaitType, speed, p4, p5);
}
extern "C" void PLAYER_RESET_PLAYER_INPUT_GAIT(Player);
void PLAYER_RESET_PLAYER_INPUT_GAIT(Player player)
{
	invoke<Void>(0x19531C47A2ABD691, player);
}
extern "C" void PLAYER_SET_AUTO_GIVE_PARACHUTE_WHEN_ENTER_PLANE(Player player, BOOL toggle);
void PLAYER_SET_AUTO_GIVE_PARACHUTE_WHEN_ENTER_PLANE(Player player, BOOL toggle)
{
	invoke<Void>(0x9F343285A00B4BB6, player, toggle);
}
extern "C" void PLAYER__0xD2B315B6689D537D(Player player, BOOL p1);
void PLAYER__0xD2B315B6689D537D(Player player, BOOL p1)
{
	invoke<Void>(0xD2B315B6689D537D, player, p1);
}
extern "C" void PLAYER_SET_PLAYER_STEALTH_PERCEPTION_MODIFIER(Player player, float value);
void PLAYER_SET_PLAYER_STEALTH_PERCEPTION_MODIFIER(Player player, float value)
{
	invoke<Void>(0x4E9021C1FCDD507A, player, value);
}
extern "C" BOOL PLAYER__0x690A61A6D13583F6(Any);
BOOL PLAYER__0x690A61A6D13583F6(Any p0)
{
	return invoke<BOOL>(0x690A61A6D13583F6, p0);
}
extern "C" void PLAYER__0x9EDD76E87D5D51BA(Player);
void PLAYER__0x9EDD76E87D5D51BA(Player player)
{
	invoke<Void>(0x9EDD76E87D5D51BA, player);
}
extern "C" void PLAYER_SET_PLAYER_SIMULATE_AIMING(Player player, BOOL toggle);
void PLAYER_SET_PLAYER_SIMULATE_AIMING(Player player, BOOL toggle)
{
	invoke<Void>(0xC54C95DA968EC5B5, player, toggle);
}
extern "C" void PLAYER_SET_PLAYER_CLOTH_PIN_FRAMES(Player player, BOOL toggle);
void PLAYER_SET_PLAYER_CLOTH_PIN_FRAMES(Player player, BOOL toggle)
{
	invoke<Void>(0x749FADDF97DFE930, player, toggle);
}
extern "C" void PLAYER_SET_PLAYER_CLOTH_PACKAGE_INDEX(int);
void PLAYER_SET_PLAYER_CLOTH_PACKAGE_INDEX(int index)
{
	invoke<Void>(0x9F7BBA2EA6372500, index);
}
extern "C" void PLAYER_SET_PLAYER_CLOTH_LOCK_COUNTER(int);
void PLAYER_SET_PLAYER_CLOTH_LOCK_COUNTER(int value)
{
	invoke<Void>(0x14D913B777DFF5DA, value);
}
extern "C" void PLAYER_PLAYER_ATTACH_VIRTUAL_BOUND(float p0, float p1, float p2, float p3, float p4, float p5, float p6, float p7);
void PLAYER_PLAYER_ATTACH_VIRTUAL_BOUND(float p0, float p1, float p2, float p3, float p4, float p5, float p6, float p7)
{
	invoke<Void>(0xED51733DC73AED51, p0, p1, p2, p3, p4, p5, p6, p7);
}
extern "C" void PLAYER_PLAYER_DETACH_VIRTUAL_BOUND();
void PLAYER_PLAYER_DETACH_VIRTUAL_BOUND()
{
	invoke<Void>(0x1DD5897E2FA6E7C9);
}
BOOL PLAYER_HAS_PLAYER_BEEN_SPOTTED_IN_STOLEN_VEHICLE(Player player)
{
	return invoke<BOOL>(0xD705740BB0A1CF4C, player);
}
extern "C" BOOL PLAYER__0x38D28DA81E4E9BF9(Player);
BOOL PLAYER__0x38D28DA81E4E9BF9(Player player)
{
	return invoke<BOOL>(0x38D28DA81E4E9BF9, player);
}
extern "C" BOOL PLAYER__0xBC0753C9CA14B506(Player player, int p1, BOOL p2);
BOOL PLAYER__0xBC0753C9CA14B506(Player player, int p1, BOOL p2)
{
	return invoke<BOOL>(0xBC0753C9CA14B506, player, p1, p2);
}
extern "C" void PLAYER__0x5006D96C995A5827(float x, float y, float z);
void PLAYER__0x5006D96C995A5827(float x, float y, float z)
{
	invoke<Void>(0x5006D96C995A5827, x, y, z);
}
extern "C" BOOL PLAYER_IS_PLAYER_RIDING_TRAIN(Player);
BOOL PLAYER_IS_PLAYER_RIDING_TRAIN(Player player)
{
	return invoke<BOOL>(0x4EC12697209F2196, player);
}
extern "C" BOOL PLAYER_HAS_PLAYER_LEFT_THE_WORLD(Player);
BOOL PLAYER_HAS_PLAYER_LEFT_THE_WORLD(Player player)
{
	return invoke<BOOL>(0xD55DDFB47991A294, player);
}
extern "C" void PLAYER__0xFF300C7649724A0B(Player player, BOOL p1);
void PLAYER__0xFF300C7649724A0B(Player player, BOOL p1)
{
	invoke<Void>(0xFF300C7649724A0B, player, p1);
}
extern "C" void PLAYER_SET_PLAYER_PARACHUTE_VARIATION_OVERRIDE(Player player, int p1, Any p2, Any p3, BOOL p4);
void PLAYER_SET_PLAYER_PARACHUTE_VARIATION_OVERRIDE(Player player, int p1, Any p2, Any p3, BOOL p4)
{
	invoke<Void>(0xD9284A8C0D48352C, player, p1, p2, p3, p4);
}
extern "C" void PLAYER_CLEAR_PLAYER_PARACHUTE_VARIATION_OVERRIDE(Player);
void PLAYER_CLEAR_PLAYER_PARACHUTE_VARIATION_OVERRIDE(Player player)
{
	invoke<Void>(0x0F4CC924CF8C7B21, player);
}
extern "C" void PLAYER_SET_PLAYER_PARACHUTE_MODEL_OVERRIDE(Player player, Hash model);
void PLAYER_SET_PLAYER_PARACHUTE_MODEL_OVERRIDE(Player player, Hash model)
{
	invoke<Void>(0x977DB4641F6FC3DB, player, model);
}
extern "C" void PLAYER_CLEAR_PLAYER_PARACHUTE_MODEL_OVERRIDE(Player);
void PLAYER_CLEAR_PLAYER_PARACHUTE_MODEL_OVERRIDE(Player player)
{
	invoke<Void>(0x8753997EB5F6EE3F, player);
}
extern "C" void PLAYER_SET_PLAYER_PARACHUTE_PACK_MODEL_OVERRIDE(Player player, Hash model);
void PLAYER_SET_PLAYER_PARACHUTE_PACK_MODEL_OVERRIDE(Player player, Hash model)
{
	invoke<Void>(0xDC80A4C2F18A2B64, player, model);
}
extern "C" void PLAYER_CLEAR_PLAYER_PARACHUTE_PACK_MODEL_OVERRIDE(Player);
void PLAYER_CLEAR_PLAYER_PARACHUTE_PACK_MODEL_OVERRIDE(Player player)
{
	invoke<Void>(0x10C54E4389C12B42, player);
}
extern "C" void PLAYER_DISABLE_PLAYER_VEHICLE_REWARDS(Player);
void PLAYER_DISABLE_PLAYER_VEHICLE_REWARDS(Player player)
{
	invoke<Void>(0xC142BE3BB9CE125F, player);
}
extern "C" void PLAYER__0x2F7CEB6520288061(BOOL);
void PLAYER__0x2F7CEB6520288061(BOOL p0)
{
	invoke<Void>(0x2F7CEB6520288061, p0);
}
extern "C" void PLAYER__0x5DC40A8869C22141(BOOL p0, ScrHandle p1);
void PLAYER__0x5DC40A8869C22141(BOOL p0, ScrHandle p1)
{
	invoke<Void>(0x5DC40A8869C22141, p0, p1);
}
extern "C" BOOL PLAYER__0x65FAEE425DE637B0(Any);
BOOL PLAYER__0x65FAEE425DE637B0(Any p0)
{
	return invoke<BOOL>(0x65FAEE425DE637B0, p0);
}
extern "C" void PLAYER__0x5501B7A5CDB79D37(Any);
void PLAYER__0x5501B7A5CDB79D37(Any p0)
{
	invoke<Void>(0x5501B7A5CDB79D37, p0);
}
extern "C" Player PLAYER__0x56105E599CAB0EFA(int);
Player PLAYER__0x56105E599CAB0EFA(int p0)
{
	return invoke<Player>(0x56105E599CAB0EFA, p0);
}
...
extern "C" Hash GAMEPLAY_GET_HASH_KEY(char*);
Hash GAMEPLAY_GET_HASH_KEY(char* value)
{ 
...
extern "C" BOOL STREAMING_HAS_MODEL_LOADED(Hash);
BOOL STREAMING_HAS_MODEL_LOADED(Hash model)
{
